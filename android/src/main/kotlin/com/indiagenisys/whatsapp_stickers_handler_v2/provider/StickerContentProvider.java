package com.indiagenisys.whatsapp_stickers_handler_v2.provider;
...
import com.indiagenisys.whatsapp_stickers_handler_v2.Stash;
import com.indiagenisys.whatsapp_stickers_handler_v2.Sticker;
import com.indiagenisys.whatsapp_stickers_handler_v2.StickerPack;
import com.indiagenisys.whatsapp_stickers_handler_v2.WhatsappStickersHandlerV2Plugin;
...
public class StickerContentProvider extends ContentProvider {
    ...
    public static final String STICKERS_ASSET = "stickers";
    ...
    public boolean onCreate() {
        Stash.init(Objects.requireNonNull(getContext()));
        authority = WhatsappStickersHandlerV2Plugin.getContentProviderAuthority(getContext());
    ...
    private AssetFileDescriptor fetchFile(@NonNull Uri uri, @NonNull AssetManager am, @NonNull String fileName, @NonNull String identifier) {
        try {
            File file = new File(getContext().getApplicationInfo().dataDir + "/app_flutter/" + STICKERS + "/" + identifier + "/", fileName);
...
//        Log.d(TAG, "readContentFile: " + Stash.getArrayList("sticker_pack", StickerPack.class));
    ...
    private Cursor getCursorForSingleStickerPack(@NonNull Uri uri) {
        ...
        Log.e("DEBUG","STICKER CONTENT PROVIDER identifier" + identifier);
        for (StickerPack stickerPack : getStickerPackList()) {
            Log.e("DEBUG","STICKER CONTENT PROVIDER sticker pack identifier" + stickerPack.identifier);
            if (identifier.equals(stickerPack.identifier)) {
                Log.e("DEBUG","STICKER CONTENT PROVIDER found sticker pack identifier" + stickerPack.identifier);
